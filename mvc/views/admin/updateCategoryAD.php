            ...
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <?php
                            while($row = mysqli_fetch_array($data["categoryMD"]))
                            {
                                echo '
                                        <form method="post">
                                                    <div class="form-row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input value="' . $row['tenhang'] . '" class="form-control py-4" id="name" name="name" type="hidden"/>
                                                                <input value="' . $row['tenhang'] . '" class="form-control py-4" type="text"/ disabled>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input value="' . $row['logo'] . '" class="form-control py-4" id="hinhanh" name="hinhanh" type="text"/>
                                                            </div>
                                                        </div> 
                                                    </div>
